    ...
    if (this.region.id) {
      this.regionService()
        ...
        .then(param => {
          this.isSaving = false;
          this.$router.go(-1);
          const message = this.$t('jhipsterTestApplicationApp.region.updated', { param: param.id });
      ...
      this.regionService()
        ...
        .then(param => {
          this.isSaving = false;
          this.$router.go(-1);
          const message = this.$t('jhipsterTestApplicationApp.region.created', { param: param.id });
