  ...
  <div class="row justify-content-center">
    <div class="col-8">
      <form name="editForm" role="form" novalidate v-on:submit.prevent="save()">
        <h2
          id="jhipsterTestApplicationApp.department.home.createOrEditLabel"
          data-cy="DepartmentCreateUpdateHeading"
          v-text="$t('jhipsterTestApplicationApp.department.home.createOrEditLabel')"
        >
        ...
        <div>
          ...
          <div class="form-group">
            <label
              ...
              v-text="$t('jhipsterTestApplicationApp.department.departmentName')"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('jhipsterTestApplicationApp.department.location')" for="department-location"
              >Location</label
            >
