  ...
  <div class="row justify-content-center">
    <div class="col-8">
      <form name="editForm" role="form" novalidate v-on:submit.prevent="save()">
        <h2
          id="jhipsterTestApplicationApp.employee.home.createOrEditLabel"
          data-cy="EmployeeCreateUpdateHeading"
          v-text="$t('jhipsterTestApplicationApp.employee.home.createOrEditLabel')"
        >
        ...
        <div>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('jhipsterTestApplicationApp.employee.firstName')" for="employee-firstName"
              >First Name</label
            >
            <input
              type="text"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('jhipsterTestApplicationApp.employee.lastName')" for="employee-lastName"
              >Last Name</label
            >
            <input
              type="text"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('jhipsterTestApplicationApp.employee.email')" for="employee-email">Email</label>
            <input
              type="text"
              class="form-control"
              name="email"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('jhipsterTestApplicationApp.employee.phoneNumber')" for="employee-phoneNumber"
              >Phone Number</label
            >
            <input
              type="text"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('jhipsterTestApplicationApp.employee.hireDate')" for="employee-hireDate"
              >Hire Date</label
            >
            <div class="d-flex">
              <input
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('jhipsterTestApplicationApp.employee.salary')" for="employee-salary">Salary</label>
            <input
              type="number"
              class="form-control"
              name="salary"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('jhipsterTestApplicationApp.employee.commissionPct')" for="employee-commissionPct"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('jhipsterTestApplicationApp.employee.manager')" for="employee-manager"
              >Manager</label
            >
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('jhipsterTestApplicationApp.employee.department')" for="employee-department"
              >Department</label
            >
