    ...
    if (this.task.id) {
      this.taskService()
        ...
        .then(param => {
          this.isSaving = false;
          this.$router.go(-1);
          const message = this.$t('jhipsterTestApplicationApp.task.updated', { param: param.id });
      ...
      this.taskService()
        ...
        .then(param => {
          this.isSaving = false;
          this.$router.go(-1);
          const message = this.$t('jhipsterTestApplicationApp.task.created', { param: param.id });
